...
<table>
<tr>
    <td style="vertical-align:top"><b>Articles:</b><br><small>Article titles,<br/> one per line</small></td>
...
<tr>
    <td><textarea name="a_find"     rows="5" cols="45">{$a_find}</textarea></td>
    <td><textarea name="a_replace"  rows="5" cols="45">{$a_replace}</textarea></td>
</tr>
</table>
<table>
<tr>
...
<tr>
    <td><textarea name="a_add"      rows="5" cols="45">{$a_add}</textarea></td>
    <td><textarea name="a_delete"   rows="5" cols="45">{$a_delete}</textarea></td>
</tr>
</table>
<table width="100%">
<tr><td align="center">
